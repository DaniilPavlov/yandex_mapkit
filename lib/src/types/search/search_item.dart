...
class SearchItem extends Equatable {
  ...
  factory SearchItem._fromJson(Map<dynamic, dynamic> json) {
    final toponymMetadata =
        json['toponymMetadata'] != null ? SearchItemToponymMetadata._fromJson(json['toponymMetadata']) : null;

    final businessMetadata =
        json['businessMetadata'] != null ? SearchItemBusinessMetadata._fromJson(json['businessMetadata']) : null;
