...
class UserLocationView extends Equatable {
  const UserLocationView._({required this.arrow, required this.pin, required this.accuracyCircle});
  ...
  UserLocationView copyWith({PlacemarkMapObject? arrow, PlacemarkMapObject? pin, CircleMapObject? accuracyCircle}) {
  ...
  Map<String, dynamic> toJson() {
    return {'arrow': arrow.toJson(), 'pin': pin.toJson(), 'accuracyCircle': accuracyCircle.toJson()};
  }
}
